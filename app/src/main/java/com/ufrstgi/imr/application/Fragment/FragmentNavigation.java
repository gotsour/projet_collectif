...
public class FragmentNavigation extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        try {
            ...
            Log.d("resultats", makeURL(47.282928, 5.993042, 47.357405, 6.349755));
            connectAsyncTask test = new connectAsyncTask(makeURL(47.282928, 5.993042, 47.357405, 6.349755));
            test.execute();
    ...
    public void onMapReady(GoogleMap googleMap) {
        {
           ...
           /* Location location = myMap.getMyLocation();
            ...
            if (location != null) {
                ...
                myMap.animateCamera(CameraUpdateFactory.newLatLngZoom(myLocation,
                        17));
            }*/
